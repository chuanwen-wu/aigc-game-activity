...
##############################################################################################
#sample command from eks 1.25 GPU stable diffusion project - by Jason Xie
# ./r_snapshot.sh -r us-west-2 -i g5.xlarge -s subnet-019a95825641bc28c us-west-2 -a /aws/service/bottlerocket/aws-k8s-1.25-nvidia/x86_64/latest/image_id 970662323538.dkr.ecr.us-west-2.amazonaws.com/sd-game-activty:latest
